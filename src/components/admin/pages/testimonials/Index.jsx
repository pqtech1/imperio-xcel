  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto bg-white min-h-screen">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Button
          onClick={() => navigate("/admin/dashboard/testimonials/create")}
                  ...
                  <TableCell className="py-4 pl-4">
                    {testimonial.client_image ? (
                      <div className="border border-gray-200 p-1 w-12 h-12 flex items-center justify-center bg-gray-50">
                        <img
                          src={`${IMG_PATH}/${testimonial.client_image}`}
                          alt={testimonial.client_name}
                          className="w-10 h-10 rounded-full object-cover"
                        />
                      </div>
                    ) : (
                      <div className="w-12 h-12 bg-gray-100 flex items-center justify-center text-xs text-gray-400 rounded-full">
                        No img
                      </div>
                    )}
                  </TableCell>
                  ...
                  <TableCell className="py-4 pl-4 pr-4">
                    <div className="flex justify-end items-center gap-2">
                      ...
                      <ActionButton
                        ...
                        onClick={() =>
                          navigate(
                            `/admin/dashboard/testimonials/${testimonial.id}`,
                          )
                        }
                      />
                      ...
                      <ActionButton
                        ...
                        onClick={() =>
                          navigate(
                            `/admin/dashboard/testimonials/${testimonial.id}/edit`,
                          )
                        }
                      />
