...
export default function EditTestimonial() {
  ...
  useEffect(() => {
    const fetchTestimonial = async () => {
      try {
        ...
        setForm({
          client_testimonial_text: res.data.client_testimonial_text || "",
          client_name: res.data.client_name || "",
          client_post: res.data.client_post || "",
          client_image: null,
        });
        if (res.data.client_image) {
          setExistingImage(res.data.client_image);
        }
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post(`/testimonials/${id}?_method=PUT`, fd, {
