...
export default function EditBlog() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post(`/blogs/${id}?_method=PUT`, fd, {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto bg-white border border-gray-200 p-8">
        <div className="text-gray-500 text-base">Loading blog data...</div>
      </div>
    );
  }
            ...
            <div className="grid gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="border border-gray-300">
                  <TiptapEditor
                    key={form.content} // Force re-render when content changes
