...
export default function EditAchievement() {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      setExistingIcon(null); // Hide existing icon when new one is selected
    } else {
      setIconPreview(null);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post(`/achievements/${id}?_method=PUT`, fd, {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Update achievement or milestone information
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {/* Show existing icon if available and no new icon selected */}
              {existingIcon && !iconPreview && (
                <div className="mb-4">
                  <p className="text-xs text-gray-500 mb-2">Current Icon:</p>
                  <div className="border border-gray-200 p-2 inline-block bg-gray-50">
                    <img
                      src={`${IMG_PATH}/${existingIcon}`}
                      alt="Current icon"
