  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto bg-white min-h-screen">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Button
          onClick={() => navigate("/admin/dashboard/achievements/create")}
            ...
            {loading ? (
              ...
              data.map((achievement, index) => (
                ...
                >
                  ...
                  <TableCell className="text-base font-semibold text-gray-900 py-4 pl-4">
                    {formatCount(achievement.count)}
                  </TableCell>
                  ...
                  <TableCell className="py-4 pl-4 pr-4">
                    <div className="flex justify-end items-center gap-2">
                      ...
                      <ActionButton
                        ...
                        onClick={() =>
                          navigate(
                            `/admin/dashboard/achievements/${achievement.id}`,
                          )
                        }
                      />
                      ...
                      <ActionButton
                        ...
                        onClick={() =>
                          navigate(
                            `/admin/dashboard/achievements/${achievement.id}/edit`,
                          )
                        }
                      />
      ...
      {data.length > 0 && (
        <div className="mt-4 text-right">
          <p className="text-sm text-gray-600">
            {data.length} {data.length === 1 ? "achievement" : "achievements"}{" "}
            total
          </p>
        </div>
      )}
